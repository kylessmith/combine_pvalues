'''
This function applies Truncated Product Method for combining pvalues.

Arguements:
	ptau: tau statistic (between 0 and 1)
	ploops: number of permutations 
	pseed: random number generator seed
	pvals: list of pvalues

Returns:
    cout: combined pvalue

Reference:
    Zaykin DV et. al.: "truncated product method for combining p-values", Genet Epidemiol. 2002
'''
